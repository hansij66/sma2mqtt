# https://github.com/TenySmart/ModbusTCP2MQTT/blob/main/models/modbus-sma-SBn_n-1AV-40.py
...
# Definition for sma_registers
# If JSONKEY is not defined, fall back to NAME
sma_definition = {
  "NAME" : 0,
  "REGISTER" : 1,
  "DATATYPE" : 2,
...
##  ['30053 - Device type',30053,'U32','ENUM'],
  ['*30057 - Serial number',30057,'U32','STRING','serial'],
...
#  ['30247 - Current event number for manufacturer',30247,'U32','FIX0'],
  ['*30513 - Total yield (Wh)',30513,'U64','FIX0','yield_total'],
...
#  ['30599 - Number of grid connections',30599,'U32','FIX0'],
  ['*30769 - DC current input [1] (A)',30769,'S32','FIX3','i_pv1'],
  ['*30771 - DC voltage input [1] (V)',30771,'S32','FIX2','v_pv1'],
  ['*30773 - DC power input [1] (W)',30773,'S32','FIX0','p_pv1'],
  ['*30775 - Power (W)',30775,'S32','FIX0','p_ac1'],
  ['*30783 - Grid voltage phase L1 (V)',30783,'U32','FIX2','v_ac1'],
#  ['30785 - Grid voltage phase L2 (V)',30785,'U32','FIX2'],
#  ['30787 - Grid voltage phase L3 (V)',30787,'U32','FIX2'],
  ['*30803 - Grid frequency (Hz)',30803,'U32','FIX2', 'f_ac'],
...
##  ['30949 - Displacement power factor ',30949,'U32','FIX3'],
  ['*30953 - Internal temperature (C)',30953,'S32','FIX1','temperature'],
  ['*30957 - DC current input [2] (A)',30957,'S32','FIX3','i_pv2'],
  ['*30959 - DC voltage input [2] (V)',30959,'S32','FIX2','v_pv2'],
  ['*30961 - DC power input [2] (W)',30961,'S32','FIX0','p_pv2'],
#  ['30975 - Intermediate circuit voltage (V)',30975,'S32','FIX2'],
  ['*30977 - Grid current phase L1 (A)',30977,'S32','FIX3','i_ac1'],
